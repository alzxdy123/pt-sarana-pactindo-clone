...
import { animFromBottomToTop } from "@/utils/animations";

function EMoney() {
  useGSAP(() => {
    animFromBottomToTop(".anim");
  }, []);

  return (
    <div className="w-full h-min py-10 pt-20">
      <div className="w-[90%] h-full mx-auto flex flex-col lg:flex-row items-center justify-between">
        {/* Carousel Section */}
        ...
        {/* Content Section */}
        <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-center px-4 gap-6">
          <img src={pacLogoCash} alt="" />
          <h5 className="text-4xl font-bold anim">eMoney</h5>
          ...
          <div className="flex gap-5 flex-wrap w-auto anim">
